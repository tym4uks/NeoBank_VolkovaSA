...
function Feedback() {
    ...
    <section className='Feedback_section'>
        ...
        <div className='Feedback__subscribe'>
            <img src={`${process.env.PUBLIC_URL}/${CARDS_PATH}/email 1.svg`}></img>
            <input type="text" placeholder='Your email'/>
            <button className='Feedback__button'><img src={`${process.env.PUBLIC_URL}/${CARDS_PATH}/Subscribe icon.svg`}></img><span>Subscribe</span></button>
        </div>
